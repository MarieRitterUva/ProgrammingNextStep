...
shinyUI(navbarPage("", 
                   ...
                   tabPanel("Instructions",
                            ...
                            p(strong("However,"), "SimulADE really is only the outer shell of a model by Grasman, Grasman, and van ",
                            ...
                            p("First and foremost, you should start on the ", em("Basic Simulation"), " page. Here you can already see a graph",
                              ...
                              "can let SimulADE know whether you want to see a ``successfull´´ output or not - so one where the patient is NOT addicted",
                              " (read: ``clean´´) at the end of the time period. Sometimes, there are no ``successfull´´ or ``unsuccessfull´´ ",
                            ...
                            p("As a next step you might want to change some parameters yourself. Check the box on the left, ",
                              ...
                              "While changing parameters back and forth habe a look at the ", em("Parameters Explained"), " tab to learn what",
